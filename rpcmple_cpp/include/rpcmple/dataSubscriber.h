...
namespace rpcmple
{
	...
	private:
		...
		std::function<void(rpcmple::variantVector)> callbackFunction;
	...
	public:
		dataSubscriber(rpcmple::connectionManager::base* pConn, std::vector<char> signature,
		               std::function<void(rpcmple::variantVector)> callback)
